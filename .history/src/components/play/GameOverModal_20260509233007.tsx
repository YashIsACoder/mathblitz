...
export function GameOverModal({ score, total, correct, onRestart, onSettings }: Props) {
  ...
  return (
    <div className="text-center space-y-8 animate-in fade-in duration-300">
      ...
      <div className="flex gap-3 justify-center">
        ...
        <button
          onClick={onSettings}
          className="px-8 py-3 bg-zinc-800 text-zinc-100 font-bold rounded border border-zinc-700 hover:bg-zinc-700 transition-colors"
        >
          Settings
        </button>
      </div>
