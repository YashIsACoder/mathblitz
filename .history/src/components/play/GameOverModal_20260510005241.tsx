...
export function GameOverModal({ score, total, correct, onRestart, onBack }: Props) {
  ...
  return (
    <div className="text-center space-y-8 animate-in fade-in duration-300">
      ...
      <div className="flex gap-3 justify-center">
        <button
          onClick={onBack}
          className="px-8 py-3 border border-zinc-700 text-zinc-300 font-bold rounded hover:bg-zinc-800 transition-colors"
        >
          Settings
        </button>
        <button
